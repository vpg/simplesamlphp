...
$config = array(
     ...
     */
    'debug' => (defined('ENV') && ENV != 'prod') ? true : false,
     ...
     */
    'showerrors' => (defined('ENV') && ENV != 'prod') ? true : false,
    'errorreporting' => (defined('ENV') && ENV != 'prod') ? true : false,
     ...
     */
    'auth.adminpassword' => 'Fsk2XyU5OJ7K',
     ...
     */
    'secretsalt' => 'v456bzn4xrm8hxnk8qfto0ifecce22h6',
    ...
    'technicalcontact_email' => 'opiegay@voyageprive.com',
     ...
     *
     */
    'logging.level' => (defined('ENV') && ENV != 'prod') ? SimpleSAML_Logger::DEBUG : SimpleSAML_Logger::ERR,
     ...
     */
    'session.cookie.domain' => IDP_DOMAIN,
     ...
     */
    'session.phpsession.cookiename' => 'IDPSessId' ,
